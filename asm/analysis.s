	...
	thumb_func_start DiskLoop_Run
DiskLoop_Run: @ 0x080F8010
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_080F82F8: .4byte 0x00000DCC
	...
	thumb_func_start DiskLoop_BlackOut
DiskLoop_BlackOut: @ 0x080F82FC
	push {r4, lr}
	adds r2, r0, #0
	ldrh r0, [r2, #4]
	subs r0, #1
...
sd_analysis_080f8408: @ 0x080F8408
	...
	adds r2, r5, r0
	ldr r0, _080F844C @ =gVideoRegBuffer+16
	ldrh r1, [r0]
	...
	adds r0, r5, #0
	bl ClearTaskBuffer
	ldr r4, _080F8458 @ =gWidgetHeaderPtr
	ldr r0, [r4]
	bl UpdateEntities
	ldr r0, [r4]
	adds r1, r5, #0
...
_080F844C: .4byte gVideoRegBuffer+16
_080F8450: .4byte 0x000001FF
_080F8454: .4byte 0x00000BAC
_080F8458: .4byte gWidgetHeaderPtr
...
printThreeDigitNumber: @ 0x080F8A24
	...
	lsrs r6, r2, #0x18
	movs r5, #0
	ldr r0, _080F8A7C @ =StringOfsTable
	mov r8, r0
_080F8A3C:
	adds r0, r4, #0
	movs r1, #0xa
	...
	bx r0
	.align 2, 0
_080F8A7C: .4byte StringOfsTable
_080F8A80: .4byte gStringData
...
clearSecretDiskData: @ 0x080F8B94
	...
	sub sp, #8
	adds r4, r0, #0
	ldr r0, _080F8BC8 @ =gStageDiskManager
	str r4, [r0]
	movs r5, #0
	str r5, [sp]
	...
	bx r0
	.align 2, 0
_080F8BC8: .4byte gStageDiskManager
...
clearSecretDiskDataHard: @ 0x080F8BD4
	...
	sub sp, #8
	adds r4, r0, #0
	ldr r0, _080F8C08 @ =gStageDiskManager
	str r4, [r0]
	movs r5, #0
	str r5, [sp]
	...
	bx r0
	.align 2, 0
_080F8C08: .4byte gStageDiskManager
...
clearStageDisk: @ 0x080F8C80
	push {r4, r5, lr}
	movs r2, #0
	ldr r5, _080F8CA8 @ =gStageDiskManager
	adds r4, r5, #4
	movs r3, #0xff
_080F8C8A:
	adds r0, r2, r4
	...
	bx r0
	.align 2, 0
_080F8CA8: .4byte gStageDiskManager
...
allSecretDiskFound: @ 0x080F8CE0
	push {r4, lr}
	movs r2, #0
	ldr r0, _080F8D08 @ =gStageDiskManager
	ldr r3, [r0]
	movs r4, #0xf
_080F8CEA:
	lsrs r0, r2, #2
	...
	b _080F8D18
	.align 2, 0
_080F8D08: .4byte gStageDiskManager
_080F8D0C:
	adds r0, r2, #1
	lsls r0, r0, #0x18
	lsrs r2, r0, #0x18
