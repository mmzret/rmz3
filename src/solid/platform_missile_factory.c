...
// Missile Factory's platform

static const struct Rect sSize;

static void Solid36_Init(struct Solid* p);
static void Solid36_Update(struct Solid* p);
static void Solid36_Die(void* _ UNUSED);

// clang-format off
const SolidRoutine gSolid36Routine = {
    [ENTITY_INIT] =      (void*)Solid36_Init,
    [ENTITY_UPDATE] =    (void*)Solid36_Update,
    [ENTITY_DIE] =       (void*)Solid36_Die,
...
static void Solid36_Die(void* _) {}

static const struct Rect sSize = {PIXEL(0), PIXEL(8), PIXEL(48), PIXEL(16)};
