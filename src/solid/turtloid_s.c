...
// clang-format off
const SolidRoutine gTurtloidSRoutine = {
    [ENTITY_INIT] =      (void*)Solid23_Init,
    [ENTITY_UPDATE] =    (void*)Solid23_Update,
    [ENTITY_DIE] =       (void*)Solid23_Die,
...
static void nop_080d8330(void* _);
...
static const struct Rect Rect_08371014 = {PIXEL(0), -PIXEL(5), PIXEL(57), PIXEL(16)};
