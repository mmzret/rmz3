...
void OverworldLoop_AfterMissileTalk(struct GameState* g) {
  switch (g->mode[3]) {
    default: {
    ...
    case 0: {
      PrintOptionMessage2(0x1326);  // じゃあ、せめて...
      g->mode[3]++;
      FALLTHROUGH;
    }
    case 1: {
      ...
      PrintOptionMessage1(0x1302);  // あ...ありがとう、みんな...
      g->mode[3]++;
      FALLTHROUGH;
    }
    case 2: {
    ...
    case 0x77: {
      ...
      PrintOptionMessage2(0x1327);  // 0x08384558: それにしても、ダークエルフのためとは言え、 ...
      g->mode[3] = 3;
      break;
    }
    case 0x7C: {
      ...
      PrintOptionMessage2(0x1328);  // 0x0838459a
      g->mode[3] = 3;
      break;
    }
  }
