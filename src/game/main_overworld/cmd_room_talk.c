...
static const TextID MissionSummaryTextIDs[MISSION_COUNT] = {
    TEXT_SYSTEM_THE_NEO_ARCADIAN, TEXT_SYSTEM_WE_VE_VERIFIED_A, TEXT_SYSTEM_WE_HAVE_DISCOVERED_A, TEXT_SYSTEM_THIS_WAS_ARESI, TEXT_SYSTEM_MISSION_SUMMARY_4, TEXT_SYSTEM_MISSION_SUMMARY_5, TEXT_SYSTEM_MISSION_SUMMARY_6, TEXT_SYSTEM_WE_HAVE_ANALYZED_THE, TEXT_SYSTEM_THIS_IS_ANEO, TEXT_SYSTEM_CONTAINERS_HAVE, TEXT_SYSTEM_THE_RUINS_OF_AN, TEXT_SYSTEM_NEO_ARCADIA_HAS,
};

static const TextID MissionAskTextIDs[MISSION_COUNT] = {
    TEXT_SYSTEM_DO_SOME_SCOUTING, TEXT_SYSTEM_MISSION_ASK_1, TEXT_SYSTEM_MISSION_ASK_2, TEXT_SYSTEM_MISSION_ASK_3, TEXT_SYSTEM_MISSION_ASK_4, TEXT_SYSTEM_MISSION_ASK_5, TEXT_SYSTEM_MISSION_ASK_6, TEXT_SYSTEM_MISSION_ASK_7, TEXT_SYSTEM_MISSION_ASK_8, TEXT_SYSTEM_MISSION_ASK_9, TEXT_SYSTEM_MISSION_ASK_10, TEXT_SYSTEM_MISSION_ASK_11,
};
...
static const TextID FreeRunStageTextIDs[FREE_STAGE_COUNT] = {
    TEXT_SYSTEM_WHERE_TO_TRANSFER_ALIAS1, TEXT_SYSTEM_WHERE_TO_TRANSFER_ALIAS2, TEXT_SYSTEM_WHERE_TO_TRANSFER_ALIAS3, TEXT_SYSTEM_WHERE_TO_TRANSFER_ALIAS4, TEXT_SYSTEM_DERELICT_SPACECRAFT, TEXT_SYSTEM_AEGIS_VOLCANO_BASE, TEXT_SYSTEM_OCEANIC_HWY_RUINS, TEXT_SYSTEM_WRFACTORY, TEXT_SYSTEM_OLD_RESIDENTIAL, TEXT_SYSTEM_MISSILE_FACTORY, TEXT_SYSTEM_TWILIGHT_DESERT, TEXT_SYSTEM_FOREST_OF_ANATRE, TEXT_SYSTEM_FRONTLINE_ICE_BASE, TEXT_SYSTEM_AREA_X2, TEXT_SYSTEM_ENERGY_FACILITY,
};

static const TextID FreeRunStageConfirmTextIDs[FREE_STAGE_COUNT] = {
    TEXT_SYSTEM_DERELICT_SPACECRAFT, TEXT_SYSTEM_AEGIS_VOLCANO_BASE, TEXT_SYSTEM_OCEANIC_HWY_RUINS, TEXT_SYSTEM_WRFACTORY, TEXT_SYSTEM_OLD_RESIDENTIAL, TEXT_SYSTEM_MISSILE_FACTORY, TEXT_SYSTEM_TWILIGHT_DESERT, TEXT_SYSTEM_FOREST_OF_ANATRE, TEXT_SYSTEM_FRONTLINE_ICE_BASE, TEXT_SYSTEM_AREA_X2, TEXT_SYSTEM_ENERGY_FACILITY, TEXT_SYSTEM_SNOWY_PLAINS, TEXT_SYSTEM_SUNKEN_LIBRARY, TEXT_SYSTEM_GIANT_ELEVATOR, TEXT_SYSTEM_SUB_ARCADIA,
};
