...
EWRAM_DATA bool8 gOnBike = FALSE;
...
EWRAM_DATA u16 wDynamicMotionPalIDs[DYNAMIC_MOTION_COUNT + 55] = {};  // 085d78f8 からの Graphic のpal.dstが入っている (08017aa8 参照)
...
EWRAM_DATA u16 wDynamicGraphicTilenums[DYNAMIC_MOTION_COUNT + 55] = {};
