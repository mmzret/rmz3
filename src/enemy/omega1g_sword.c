...
const EnemyRoutine gOmegaGoldSwordRoutine = {
    [ENTITY_INIT] =      (void*)OmegaGoldSword_Init,
    [ENTITY_UPDATE] =    (void*)OmegaGoldSword_Update,
    [ENTITY_DIE] =       (void*)OmegaGoldSword_Die,
...
static const Coords32 Coord_ARRAY_08368e54[4] = {
    {PIXEL(0), -PIXEL(107)},
    {PIXEL(0), -PIXEL(76)},
    {PIXEL(0), -PIXEL(48)},
    {PIXEL(0), -PIXEL(24)},
...
static const Coords32 Coord_ARRAY_08368e8c[4] = {
    {-PIXEL(23), -PIXEL(110)},
    {-PIXEL(2), -PIXEL(91)},
    {PIXEL(16), -PIXEL(73)},
    {PIXEL(34), -PIXEL(53)},
...
// clang-format off
static const Coords32 Coord_ARRAY_08368ec4[6] = {
    {PIXEL(0), -PIXEL(89)},
    {PIXEL(12), -PIXEL(75)},
    {PIXEL(27), -PIXEL(61)},
    {PIXEL(41), -PIXEL(47)},
