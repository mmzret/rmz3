...
NAKED static void Batring_Init(struct Enemy* p) {
  asm(".syntax unified\n\
	...
	adds r0, r0, r1\n\
	str r0, [r6, #0x58]\n\
	ldr r0, _08067024 @ =gSystemSavedata\n\
	ldrb r1, [r0, #0x14]\n\
	movs r0, #8\n\
	ands r0, r1\n\
	cmp r0, #0\n\
	...
	b _080670A0\n\
	.align 2, 0\n\
_08067024: .4byte gSystemSavedata\n\
...
_08067048:\n\
	ldr r0, _0806707C @ =gSystemSavedata\n\
	ldrb r1, [r0, #0x14]\n\
	movs r0, #8\n\
	ands r0, r1\n\
	cmp r0, #0\n\
	...
	b _080670A0\n\
	.align 2, 0\n\
_0806707C: .4byte gSystemSavedata\n\
